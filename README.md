...
3. Availability is not logged every 15s. 
...
4. Moving the sleep timer to a separate thread doesn't solve all of timing problems, and introduces one of its own. 
